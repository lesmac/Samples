...
public class BluetoothController {
    ...
    public boolean actOncreat(){
         ...
         mShow = (TextView) act.findViewById(R.id.textView1);
	...
	public void Buttonhandler(int id) {
		...
		switch (id){
		    ...
		    case 2: SendMessage(BluetoothHDPService.MSG_UNREG_HEALTH_APP, 0);
		            //pass bp to other module. and jump to next screen
		            AppState app = (AppState) act.getApplication();
		            numericBP[] bparr = {bp};
		            app.setBPArray(bparr);
		            app.setstate(AppState.STATE_BLUETOOTH_DONE);
